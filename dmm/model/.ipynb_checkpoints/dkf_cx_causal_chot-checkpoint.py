...
def build_DKF_cx_causal_chot(cfg, device='cpu'):
...
#     gamma = cfg.getfloat('Training', 'gamma')
    ...
    # Build model
    model = DKF_cx_causal_chot(c_dim=c_dim, x_dim=x_dim, z_dim=z_dim, tau=tau,
...
class DKF_cx_causal_chot(nn.Module):
    ...
    def build(self):
        ...
        self.rnn_gx = nn.LSTM(self.dense_x_gx, self.dim_RNN_gx, self.num_RNN_gx)
...
#         )
    ...
    def generation_x(self, z):
        ...
        gen_logvar = torch.clamp(gen_logvar, min=-5, max=5) 
