...
from .utils import myconf, get_logger, loss_KLD_cov
from .dataset import data_split, MUA_dataset, BalancedDataLoader, one_hot_cont
from .model import build_DKF_simple
...
class LearningAlgorithm_dir():
    ...
    def train(self):
        ...
        for epoch in range(start_epoch+2, epochs+1):
            ...
            # Early stop patiance
            if val_loss[epoch-1] < best_val_loss or kl_warm < 1 or epoch==int(kl_warm_steps/kl_slope): 
